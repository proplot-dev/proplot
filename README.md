 ...
 * Improved `subplots` command, much more flexible.
 ...
 * Added complex features to `subplots command.
 ...
 * Added new `format` method-style commands to axes objects generated with `subplots`.
 ...
 * Revised some underlying issues by overwriting existing functions.
