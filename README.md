...
### The `subplots` command
   ...
   * Automatic sizing: specify a width (height) with a subplot *aspect ratio*, and `subplot` will automatically determine the necessary height (width) required to preserve that aspect ratio.
