...
`cartopy <https://scitools.org.uk/cartopy/docs/latest/>`\ \_\_ and
``basemap <https://matplotlib.org/basemap/index.html>``\ \_\_ packages.
This feature is optional – if you don’t care about cartographic
projections, you don’t need to have `cartopy` or
`~mpl_toolkits.basemap` installed. Map projection axes generated by
