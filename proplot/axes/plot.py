...
from ..internals import _not_none, _state_context, docstring, warnings
...
def _parse_1d(self, func, *args, autoformat=None, **kwargs):
    """
...
def _deprecate_indicate_error(func):
    """
