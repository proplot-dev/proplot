...
def Colormap(*args, name=None, cyclic=None, listed=False, fade=None, cycle=None,
    ...
    *args : colormap-spec
        ...
        * If list of RGB tuples or color strings, and `listed` is ``True`` (the
          default), a `PerceptuallyUniformColormap` is generated by passing the
          list to the `~PerceptuallyUniformColormap.from_list` method. If `listed`
          is ``False``, a `~matplotlib.colors.ListedColormap` is generated.
    ...
    """
    # Initial stuff
    # NOTE: There are two ways to create discretized color levels from a
    ...
    # The second is easier to implement and has low impact on speed.
