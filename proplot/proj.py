...
``'aitoff'``                          `Aitoff <https://proj4.org/operations/projections/aitoff.html>`_                             ✓         ✗
...
``'hammer'``                          `Hammer <https://proj4.org/operations/projections/hammer.html>`_                             ✓         ✓
``'igh'``                             `Interrupted Goode Homolosine <https://proj4.org/operations/projections/igh.html>`_          ✓         ✗
``'kav7'``                            `Kavrayskiy VII <https://proj4.org/operations/projections/kav7.html>`_                       ✓         ✓
...
``'wintri'``                          `Winkel tripel <https://proj4.org/operations/projections/wintri.html>`_                      ✓         ✗
====================================  ===========================================================================================  ========  =======
"""
#------------------------------------------------------------------------------#
