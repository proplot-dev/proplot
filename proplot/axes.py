...
from .wrappers import (
    _get_transform, _no_recurse, _redirect,
...
class BasemapAxes(ProjectionAxes):
    ...
    # Wrapped methods
    plot       = _no_recurse(_default_latlon(Axes.plot))
    scatter    = _no_recurse(_default_latlon(Axes.scatter))
    contour    = _no_recurse(_default_latlon(Axes.contour))
    contourf   = _no_recurse(_default_latlon(Axes.contourf))
    quiver     = _no_recurse(_default_latlon(Axes.quiver))
    streamplot = _no_recurse(_default_latlon(Axes.streamplot))
    barbs      = _no_recurse(_default_latlon(Axes.barbs))
    pcolor     = _no_recurse(_default_latlon(Axes.pcolor))
    pcolormesh = _no_recurse(_default_latlon(Axes.pcolormesh))
    hexbin     = _no_recurse(_default_latlon(Axes.hexbin))
    imshow     = _no_recurse(_default_latlon(Axes.imshow))
